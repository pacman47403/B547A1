...
The usb device when pluged in the system is loaded as a CD ROM. The Get/Load
...
When a correct credentials are entered by the user, the password key is sent to
...
When the user enters an invalid credentials, the header decrypt fails and the
counter is incremented. The user is then prompted to enter a correct password.
